...
@Named
@SessionScoped
public class BrowsingHistoryController implements Serializable {

    private static final long serialVersionUID = 1L;

    private Stack pageStack = new Stack<String>();
    ...
    public String getBackUrl() {
        ...
        if (stackSize > 1) {
            return (String)pageStack.get(stackSize - 2);
        }
        // Just in case hasPageBack was not implemented (be safe)
        return (String)pageStack.get(stackSize - 1);
    }
    ...
    public void setPageStack(Stack pageStack) {
